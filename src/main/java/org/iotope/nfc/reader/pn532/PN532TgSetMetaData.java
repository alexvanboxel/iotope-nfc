...
public class PN532TgSetMetaData extends PN532AbstractCommand<PN532TgSetMetaData, PN532TgSetMetaDataResponse> {
    
    public PN532TgSetMetaData() {
        super(PN532TgSetMetaDataResponse.class);
    }

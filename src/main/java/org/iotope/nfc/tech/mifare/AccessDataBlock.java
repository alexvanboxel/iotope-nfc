...
class AccessDataBlock {
	...
	public AccessDataBlock(Access read, Access write, Access increment,
			Access decrement) {
		this.read = read;
		this.write = write;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AccessDataBlock other = (AccessDataBlock) obj;
	...
	public String toString() {
		return "AccessDataBlock [R=" + read + ", W=" + write
